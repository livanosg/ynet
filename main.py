...
# Mode
PARSER.add_argument('-M', '--mode', type=str, default='test', choices=['train', 'eval', 'infer', 'train-and-eval', 'make-labels', 'test', 'lr'],  # TODO EXPORT MODEL
...
PARSER.add_argument('-lr', '--lr', type=float, default=0.00005, help='Learning Rate.')
