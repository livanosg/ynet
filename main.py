...
# Model options
PARSER.add_argument('-load', '--load_model', type=str, default='MR_trial_0', help=' If declared, the model saved will be loaded.')
...
PARSER.add_argument('-e', '--epochs', type=int, default=98, help='Training epochs.')
